 ...
 * @package Ajima
 */
$enable_category_meta = ajima_get_option('enable_category_meta');
$enable_date_meta = ajima_get_option('enable_date_meta');
$enable_post_excerpt = ajima_get_option('enable_post_excerpt');
$enable_author_meta = ajima_get_option('enable_author_meta');
$footer_recommended_post_title = ajima_get_option('footer_recommended_post_title');
$select_cat_for_footer_recommended_post = ajima_get_option('select_cat_for_footer_recommended_post');
?>
