 ...
 * @package Ajima
 */
if (!function_exists('ajima_get_default_customizer_values')) :
    /**
     ...
     */
    function ajima_get_default_customizer_values()
    {
        ...
        $defaults['advertisement_section_title'] = esc_html__('Welcome Advertisement Message', 'ajima');
        ...
        $defaults['banner_section_slider_layout'] = 'site-banner-layout-2';
        ...
        $defaults['popular_section_post_title'] = esc_html__('Popular Post', 'ajima');
        ...
        $defaults['related_posts_text'] = esc_html__('You May Also Like', 'ajima');
        ...
        $defaults['author_posts_text'] = esc_html__('More From Author', 'ajima');
        ...
        $defaults['footer_recommended_post_title'] = esc_html__('You May Also Like:', 'ajima');
        ...
        $defaults['copyright_text'] = esc_html__('Copyright &copy;', 'ajima');
        ...
        $defaults = apply_filters('ajima_default_customizer_values', $defaults);
        return $defaults;
    }
endif;
