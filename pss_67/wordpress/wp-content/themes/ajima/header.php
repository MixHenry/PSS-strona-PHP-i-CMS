...
<?php do_action( 'ajima_before_site' ); ?>
...
<div id="page" class="site">
    ...
    <?php $ed_header_ad = ajima_get_option( 'ed_header_ad' );
    if ($ed_header_ad) {
    ...
    <a class="skip-link screen-reader-text" href="#primary"><?php esc_html_e('Skip to content', 'ajima'); ?></a>

    <?php do_action( 'ajima_before_header' ); ?>

    <?php get_template_part('template-parts/header/theme-header'); ?>

    <?php do_action( 'ajima_before_content' ); ?>
    <?php $is_banner_section = ajima_get_option('enable_banner_section');
    if ($is_banner_section && (is_home() || is_front_page()) && !is_paged()) {
        get_template_part('template-parts/front-page/banner-section');
    }

    $enable_popular_section = ajima_get_option('enable_popular_section');
