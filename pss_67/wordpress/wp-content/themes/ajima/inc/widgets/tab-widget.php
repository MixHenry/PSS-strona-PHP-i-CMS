...
class Ajima_Tab_Posts extends Ajima_Widget_Base
{
    /**
    ...
    {
        $this->widget_cssclass = 'widget_ajima_tab_posts';
        $this->widget_description = __("Displays Tab Widget", 'ajima');
        $this->widget_id = 'ajima_tab_posts';
        $this->widget_name = __('Ajima: Tab Posts', 'ajima');
        $this->settings = array(
            'popular_heading' => array(
                'label' => esc_html__('Popular', 'ajima'),
                'type' => 'heading',
            ),
            'popular_number' => array(
                'label' => esc_html__('No. of Posts:', 'ajima'),
                'type' => 'number',
                'css' => 'max-width:60px;',
                'default' => 5,
                'min' => 1,
            ...
            'comments_heading' => array(
                'label' => esc_html__('Comments', 'ajima'),
                'type' => 'heading',
            ),
            'comments_number' => array(
                'label' => esc_html__('No. of Comments:', 'ajima'),
                'type' => 'number',
                'css' => 'max-width:60px;',
                'default' => 5,
                'min' => 1,
            ...
            'tagged_heading' => array(
                'label' => esc_html__('Tagged', 'ajima'),
                'type' => 'heading',
            ),
            'select_image_size' => array(
                'label' => esc_html__('Select Image Size Featured Post:', 'ajima'),
                'type' => 'select',
                'default' => 'medium',
                'options' => array(
                    'thumbnail' => esc_html__('Thumbnail', 'ajima'),
                    'medium' => esc_html__('Medium', 'ajima'),
                    'large' => esc_html__('Large', 'ajima'),
                    'full' => esc_html__('Full', 'ajima'),
                ),
            ),
            'style' => array(
                'type' => 'select',
