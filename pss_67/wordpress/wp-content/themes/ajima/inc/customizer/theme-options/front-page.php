...
$wp_customize->add_section(
    ...
    array(
        'title'      => __( 'Front Page Sidebar Options', 'ajima' ),
...
$wp_customize->add_setting(
    'ajima_options[front_page_layout]',
    array(
...
$wp_customize->add_control(
    new Ajima_Radio_Image_Control(
        ...
        'ajima_options[front_page_layout]',
        array(
            'label'	=> __( 'Front Page Sidebar Layout', 'ajima' ),
...
$wp_customize->add_setting(
    'ajima_options[hide_front_page_sidebar_mobile]',
    array(
...
$wp_customize->add_control(
    'ajima_options[hide_front_page_sidebar_mobile]',
    array(
        'label'       => __( 'Hide Front Page Sidebar on Mobile', 'ajima' ),
        'section'     => 'home_page_layout_options',
        'type'        => 'checkbox',
    )
);
...
$wp_customize->add_setting(
    'ajima_options[front_page_enable_sidebar]',
    array(
...
$wp_customize->add_control(
    'ajima_options[front_page_enable_sidebar]',
    array(
        'label'       => __( 'Different sidebar for the front page.', 'ajima' ),
        'section'     => 'home_page_layout_options',
        'description' => __( 'Widgets on this sidebar widget will reset if disabled.', 'ajima'),
        'type'        => 'checkbox',
    )
);