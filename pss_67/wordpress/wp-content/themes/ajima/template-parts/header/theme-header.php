...
$enable_header_bg_overlay = ajima_get_option('enable_header_bg_overlay');
$header_image_size = ajima_get_option('header_image_size');
$enable_top_bar = ajima_get_option('enable_top_bar');
