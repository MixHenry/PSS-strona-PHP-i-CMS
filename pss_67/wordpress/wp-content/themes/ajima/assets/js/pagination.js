...
let loadButtonWrapper = document.querySelector(".ajima-load-posts-btn-wrapper");
let loadButton = document.querySelector(
    ".ajima-load-posts-btn-wrapper .load-btn"
);
let loader = document.querySelector(".ajima-ajax-loader");

let loadType = loadButtonWrapper.getAttribute("data-load-type");
let articleWrapper = document.querySelector(".ajima-article-wrapper");
    ...
    fetchThePosts: function () {
        ...
        fetch(AjimaVars.ajaxurl, {
            ...
            body: new URLSearchParams({
                action: "ajima_load_posts",
                nonce: AjimaVars.nonce,
                query_vars: AjimaVars.query_vars,
                page: nextPage,
            }),
        })
            .then((response) => {
