...
$related_posts_text = ajima_get_option('related_posts_text');
$no_of_related_posts = absint(ajima_get_option('no_of_related_posts'));
$order = esc_attr(ajima_get_option('related_posts_order'));
$orderby = esc_attr(ajima_get_option('related_posts_orderby'));
