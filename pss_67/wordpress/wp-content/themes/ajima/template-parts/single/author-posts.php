...
$author_posts_text = ajima_get_option('author_posts_text');
$no_of_author_posts = absint(ajima_get_option('no_of_author_posts'));
$order = esc_attr(ajima_get_option('author_posts_order'));
$orderby = esc_attr(ajima_get_option('author_posts_orderby'));
