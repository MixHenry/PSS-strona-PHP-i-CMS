 ...
 * @package Ajima
 */
$ed_header_type = ajima_get_option( 'ed_header_type' );
$upload_add_image = ajima_get_option( 'upload_add_image' );
$ed_header_link = ajima_get_option( 'ed_header_link' );
$advertisement_section_title = ajima_get_option( 'advertisement_section_title' );
?>
            ...
            <header class="welcome-screen-header">
                ...
                <div class="welcome-screen-actions">
                    ...
                    <button type="button" class="welcome-screen-skip">
                        <?php echo esc_html__('Skip This', 'ajima') ?>
                    </button>
                </div>
            </header>
        <?php } ?>
